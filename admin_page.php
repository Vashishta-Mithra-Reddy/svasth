    ...
    <header>
        <nav>
            <ul class="nav-ul">
				...
				<li class="nav-li" id="logo-contain">
                    ...
                    <li class="nav-li"><a href="all_appointments.php" target="mainframe">Appointments</a></li>
                    <li class="nav-li"><a href="new_appointment.php" target="mainframe">New Appointment</a></li>
                    <li class="nav-li"><a href="patient_registration.html" target="mainframe">Patient Registration</a></li>
                    <li class="nav-li"><a href="team.php" target="mainframe">Team</a></li>
        ...
        <aside>
            <ul class="sidebar-ul">
                    ...
                    <li class="sidebar-li"><a href="all_appointments.php" target="mainframe">Appointments</a></li>
                    <li class="sidebar-li"><a href="new_appointment.php" target="mainframe">New Appointment</a></li>
                    <li class="sidebar-li"><a href="patient_registration.html" target="mainframe">Patient Registration</a></li>
                    <li class="sidebar-li"><a href="team.php" target="mainframe">Team</a></li>
        ...
        <div class="footer-content">
            ...
            <div class="footer-links">
                ...
                <ul>
                    ...
                    <li ><a href="all_appointments.php" target="mainframe">Appointments</a></li>
                    <li ><a href="new_appointment.php" target="mainframe">New Appointment</a></li>
                    <li ><a href="patient_registration.html" target="mainframe">Patient Registration</a></li>
                    <li ><a href="team.php" target="mainframe">Team</a></li>
