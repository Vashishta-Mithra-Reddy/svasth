        ...
        <nav>
            <ul class="nav-ul">
				...
				<li class="nav-li" id="logo-contain">
                    ...
                    <li class="nav-li"><a href="records.php" target="mainframe">Your Records</a></li>
                    <li class="nav-li"><a href="myappointments.php" target="mainframe">My Appointments</a></li>
                    
                    <li class="nav-li"><a href="blank.html" target="_top">Logout</a></li>
            </ul>
        </nav>
        <aside>
            <ul class="sidebar-ul">
                    <li class="sidebar-li"><a href="records.php" target="mainframe">Your Records</a></li>
                    <li class="sidebar-li"><a href="myappointments.php" target="mainframe">My Appointments</a></li>
                    <li class="sidebar-li"><a href="dashboard.html" target="mainframe">Dashboard</a></li>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-links">
                <h3>Quick Links</h3>
                <ul>
                    <li><a href="records.php" target="mainframe">Your Records</a></li>
                    <li><a href="myappointments.php" target="mainframe">My Appointments</a></li>        
                    <li><a href="dashboard.html" target="mainframe">Dashboard</a></li>
                    <li><a href="blank.html" target="_top">Logout</a></li>
                </ul>
            </div>
